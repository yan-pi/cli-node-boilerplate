...
const cli = meow(
    ...
    Options
      --project_name, -n  What is your project name?
      --packageManager, -p  Choose a package manager: npm, yarn, pnpm (default: pnpm)
      --framework, -f  Choose a framework to use: express, fastify (default: fastify)

    Examples
      $ my-cli --project_name=my-project --packageManager=yarn --framework=express
`,
	{
...
const getLatestVersion = async (packageName, packageManager) => {
...
const createProject = async (project_name, packageManager, framework) => {
